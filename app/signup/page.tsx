              ...
              <div>
                ...
                <input
                  {...register("password", {
                    ...
                    validate: {
                      hasUppercase: (v) => /[A-Z]/.test(v) || "Password must include at least one uppercase letter",
                      hasLowercase: (v) => /[a-z]/.test(v) || "Password must include at least one lowercase letter",
                      hasNumber: (v) => /\d/.test(v) || "Password must include at least one number",
                      hasSpecialChar: (v) => /[!@#$%^&*(),.?":{}|<>]/.test(v) || "Password must include at least one special character",
                      notCommon: (v) => !["password","12345678","qwerty","letmein"].includes(v.toLowerCase()) || "Password is too common",
                    },
                  })}
                  type="password"
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border"
